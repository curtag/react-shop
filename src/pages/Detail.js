...
const Detail = ({match, cartItems, shopItems, setCartItems, getItemQty}) => {
    ...
    <div>
      <div>
        ...
        <div className="item-input-container">
          <button type="button" className="item-decrementbutton" onClick={decrementItemCount} >-</button>
          <input className="item-input" type="number" min="0" max="99" defaultValue={qty} maxLength="2" value={qty} onChange={(e) => updateItemCount(e)}></input>
          <button type="button" className="item-incremementbutton" onClick={incrementItemCount}>+</button>
        </div>
